...
def run_agent(pod_name, namespace):
    ...
    #     '{"owner":"ahmbas","repo":"etx-agentic-ai",'
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'ahmbas', repo 'etx-agentic-ai', "
